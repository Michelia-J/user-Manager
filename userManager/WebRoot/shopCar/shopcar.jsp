...
<%@ page import="com.fz.javabean.GoodsSingle" %>
<!-- 通过动作标识，获取ShopCar类实例 -->
<jsp:useBean id="myCar" class="com.fz.toolbean.ShopCar" scope="session"/>
<% 
...
<table border="1" width="450" rules="none" cellspacing="0" cellpadding="0">
	...
	<tr align="center" height="50">
		...
		<td><%=money%></td>
		<td>
<a href="docar?action=remove&name=<%=single.getName() %>">移除</a>
</td>
	</tr>
	<%							
			}
	...
	<tr height="50" align="center">
		...
		<td colspan="4"><a href="account?total=<%=total%>">记账</a></td>
